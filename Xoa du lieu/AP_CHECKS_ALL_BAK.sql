-- Drop table
-- drop table AP_CHECKS_ALL_BAK
-- Create table
--AP_CHECKS_ALL_BAK
--drop table BACKUP.EVN_AP_CHECKS_ALL_BAK;
create table BACKUP.EVN_AP_CHECKS_ALL
(
  ...
  check_number                   NUMBER(15) not null,
  currency_code                  VARCHAR2(15) not null,
  last_updated_by                NUMBER(15) not null,
  last_update_date               DATE not null,
  payment_method_lookup_code     VARCHAR2(25),
  payment_type_flag              VARCHAR2(25) not null,
